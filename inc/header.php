                ...
                <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                    ...
                    <div class="header__top--right d-flex align-items-center">
                        <ul class="header__top--link d-flex align-items-center">
                            <li class="header__link--menu"><a class="header__link--menu__text text-white" href="#">
                                <li class="header__menu--items">
                                    <a class="header__menu--link text-white" href="#"><?php echo $_SESSION["lang"] ?> 
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg>
                                    </a>
                                    <ul class="header__sub--menu">
                                        <?php if($_SESSION["lang"] != "al"): ?>
                                            <li class="header__sub--menu__items"><a href="?lang=al" class="header__sub--menu__link">Albanian</a></li>
                                        <?php endif; ?>
                                        <?php if($_SESSION["lang"] != "mq"): ?>
                                            <li class="header__sub--menu__items"><a href="?lang=mq" class="header__sub--menu__link">Macedonian</a></li>
                                        <?php endif; ?>
            ...
            <div class="container-fluid">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        ...
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.html">A <span style="color: #ED1D24">T</span></a></h1>
                    ...
                    <div class="header__menu style3 d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="header__menu--wrapper d-flex">
                                <li class="header__menu--items">
                                    <a class="header__menu--link active" href="index.php">
                                        <?= $lang["nav-link-1"] ?> 
                                    </a>
                                </li>
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link" href="shop.php"><?php echo $lang["nav-link-2"] ?> 
                                        
                                    </a>
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="about.php"><?php echo $lang["nav-link-3"] ?></a>  
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="#"><?php echo $lang["nav-link-4"] ?> 
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg>
                                    </a>
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="contact.php"><?php echo $lang["nav-link-5"] ?> </a>  
                                </li>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <ul class="header__account--wrapper d-flex align-items-center">
                            <li class="header__account--items  header__account--search__items d-sm-2-none">
                                <a class="header__account--btn search__open--btn" href="javascript:void(0)" data-offcanvas>
                                    ...
                                    <span class="visually-hidden"><?php echo $lang["search"] ?></span>  
                                </a>
                            </li>
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="index.php"><?php echo $lang["nav-link-1"] ?></a>
                            
                        </li>
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="shop.php"><?php echo $lang["nav-link-2"] ?></a>
                            
                        </li>
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="#"><?php echo $lang["nav-link-4"] ?></a>
                            <ul class="offcanvas__sub_menu">
                                <li class="offcanvas__sub_menu_li"><a href="about.php" class="offcanvas__sub_menu_item"><?php echo $lang["nav-link-3"] ?></a></li>
                                <li class="offcanvas__sub_menu_li"><a href="contact.php" class="offcanvas__sub_menu_item"><?php echo $lang["nav-link-5"] ?></a></li>
                                
                            </ul>
                        </li>
                        <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="about.php"><?php echo $lang["nav-link-3"] ?></a></li>
                        <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="contact.php"><?php echo $lang["nav-link-5"] ?></a></li>
                    </ul>
            ...
            <ul class="d-flex justify-content-between">
                <li class="offcanvas__stikcy--toolbar__list">
                    ...
                    <span class="offcanvas__stikcy--toolbar__icon"> 
                        ...
                        <span class="offcanvas__stikcy--toolbar__label"><?php echo $lang["nav-link-1"] ?></span>
                    </a>
                </li>
                <li class="offcanvas__stikcy--toolbar__list">
                    ...
                    <span class="offcanvas__stikcy--toolbar__label"><?php echo $lang["nav-link-2"] ?></span>
                    </a>
                </li>
                <li class="offcanvas__stikcy--toolbar__list ">
                    ...
                    <span class="offcanvas__stikcy--toolbar__label"><?php echo $lang["search"] ?></span>
                    </a>
                </li>
                <li class="offcanvas__stikcy--toolbar__list">
